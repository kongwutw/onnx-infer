import { Tensor as TensorInterface, TensorFromImageOptions, TensorToImageDataOptions } from './index';
...
export declare class Tensor implements TensorInterface {
    ...
    static fromImage(urlSource: string, options?: TensorFromImageOptions): Promise<Tensor>;
